...
public class HybridQueryPhaseSearcher extends QueryPhase.DefaultQueryPhaseSearcher {
    ...
    private static void printQueryResults(SearchContext searchContext, QuerySearchResult queryResult) {
        ...
        CompoundTopDocs multiQueryTopDocs = (CompoundTopDocs) topDocsAndMaxScore.topDocs;
    ...
    void postProcess(QuerySearchResult queryResult, HybridTopScoreDocCollector collector) {
    ...
    TopDocsAndMaxScore newTopDocs(HybridTopScoreDocCollector collector) {
