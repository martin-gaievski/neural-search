...
public final class HybridQueryBuilder extends AbstractQueryBuilder<HybridQueryBuilder> {
    ...
    private QueryBuilder doRewriteFused(QueryRewriteContext queryRewriteContext) throws IOException {
        ...
        // empty one. When all of that holds, the legs fetch the user's fields so the page can be assembled from them, and
        // round 2 is not needed unless the legs' answers force it (buildFusedResult decides that once they are in).
