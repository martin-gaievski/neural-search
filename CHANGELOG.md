...
* In-query fusion in hybrid search. Skip round 2's Tail when the legs already prove the request's `hits.total` ([#TBD](https://github.com/opensearch-project/neural-search/pull/TBD))
