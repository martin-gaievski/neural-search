...
### Features
* [Hybrid Query] POC: condition-based result boost via ordered `boost_conditions` (promote docs matching per-campaign filters into tier bands, no per-doc fields); multi-node-safe tier transport via the hybrid sentinel envelope
